...
const AlumniRelationsPage = () => {
  return (
    <Layout>
      <style>{`
        /* --- ALUMNI RELATIONS BODY STYLES --- */
        .alumni-container {
          padding: 20px;
          background-color: #ffffff;
          border-radius: 12px;
      ...
      <div className="alumni-container">
        <h1 className="alumni-title">Alumni Relations</h1>
        <h2 className="committee-title">ALUMNI RELATION COMMITTEE</h2>
